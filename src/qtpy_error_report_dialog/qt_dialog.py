...
from qtpy_error_report_dialog.base import ErrorReportDialogBase
from qtpy_error_report_dialog.error_report_dialog_ui import Ui_Dialog

if TYPE_CHECKING:
    from qtpy.QtGui import QCloseEvent
    from qtpy.QtWidgets import QWidget

    from qtpy_error_report_dialog.base import ErrorReportData
